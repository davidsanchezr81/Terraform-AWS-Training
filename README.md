...
- Another way to check the individual resource details through the command line is by runnin **terraform state show resource-name**, where resource name in this case will be _aws_vpc.mtc_vpc_
